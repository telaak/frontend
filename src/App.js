    ...
    var startApp = function() {
      window.gapi.load('auth2', function() {
        ...
        window.auth2 = window.gapi.auth2.init({
          client_id:
            '173174574853-jg0frpr5qbc0qddb056v7b6ob0143fhi.apps.googleusercontent.com',
    ...
    function attachSignin(element) {
      window.auth2.attachClickHandler(
        ...
        function(googleUser) {
          ...
          document.getElementById('showStoreNav').style.display =
            'inline-block';
          document.getElementById('showAdminNav').style.display =
            'inline-block';
          document.getElementById('navBarUserName').innerText =
